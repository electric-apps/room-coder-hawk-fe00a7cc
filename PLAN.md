...
## App Description
A real-time, reactive todo application that syncs across all clients instantly using Electric SQL. Users can create, complete, and delete todos with optimistic updates for a snappy feel.
